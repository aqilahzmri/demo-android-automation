...
import com.testing.firetasmiktiga.adapter.CourseAdapter;
import com.testing.firetasmiktiga.course.CreateCourseDialog;
import com.testing.firetasmiktiga.model.Course;
import com.testing.firetasmiktiga.model.User;
...
public class HomeActivity extends AppCompatActivity {
        ...
        courseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (currentUser.getUid().equals(course.getCourseTeacherId())) { // Teacher
                   ...
                   /* if (course != null) {
                        ...
                        studentRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                                ...
                                if(dataSnapshot2.hasChild(currentUser.getUid())){ //Student
                                    courseList.add(course);
                                    courseAdapter.notifyDataSetChanged();
                                }
    ...
    //if student entered the correct code, student's course information is stored in the database.
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (countIfCourseCode == 0)
                    Toast.makeText(HomeActivity.this, "Please enter a valid code.", Toast.LENGTH_LONG).show();
            }
